# Licensing — nirs4all-cockpit

`nirs4all-cockpit` is part of the **nirs4all ecosystem** and is offered under a
...
You may use, modify, and redistribute this software under the terms of **either**, at
your option:

1. the **CeCILL Free Software License Agreement, version 2.1** — full text in
   [`LICENSES/CeCILL-2.1.txt`](LICENSES/CeCILL-2.1.txt); **or**
2. the **GNU Affero General Public License, version 3.0 or (at your option) any later
   version** — full text in [`LICENSES/AGPL-3.0-or-later.txt`](LICENSES/AGPL-3.0-or-later.txt).
...
Unless a separate commercial agreement is explicitly in place, your use of this code is
governed by the open-source terms above.

## 2. Commercial license

If the copyleft obligations of CeCILL-2.1 / AGPL-3.0-or-later do not fit your use case —
for example, embedding `nirs4all-cockpit` in a **proprietary, closed-source product or SaaS**
...
- **For any commercial use, contact: <nirs4all-admin@cirad.fr>.**

## 3. Third-party components

`nirs4all-cockpit` relies on third-party open-source components. Their licenses are summarized
