...
def test_python_oracle_web_client_and_shared_ui_are_separate() -> None:
    ...
    assert "n4a-v1-rc2-2026.07-studio-main-installer" in studio_release_reason
...
def test_studio_windows_rc_smoke_is_tracked_as_manual_blocker() -> None:
    ...
    assert action.manual_url == "https://github.com/GBeurier/nirs4all-studio/releases/tag/n4a-v1-rc2-2026.07-studio-main-installer"
...
def test_current_runiverse_manual_actions_cover_release_rebuilds() -> None:
    ...
    expected = {
        ...
        "runiverse-datasets-rebuild": ("nirs4all-datasets", "nirs4alldatasets", "v0.3.8", "todo"),
    }
