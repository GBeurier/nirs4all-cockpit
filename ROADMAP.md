...
- **nirs4all-formats** (`0.2.7` train) — pypi`nirs4all-formats`; crates`nirs4all-formats{,-core,-capi,-cli}`; npm`@nirs4all/formats-wasm`; r-universe`nirs4allformats`; CRAN explicitly excluded / R-universe-only for `nirs4allformats`.
...
- **nirs4all-core** (`0.3.9` train) — pypi`nirs4all-core`; github-release`nirs4all-core`; crates/npm/r-universe logical package name `nirs4all`.
